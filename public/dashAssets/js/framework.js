  ...
  var CosticFramework = (function(){
    ...
    function setActiveMenuItem(){
      ...
      $('.ms-main-aside .menu-item a', $('#ms-side-nav')).each(function() {
        ...
        if (href == current  || (current.indexOf('subCategories') !== -1 && $this.attr('href').indexOf("categories/list") !== -1) || (current.indexOf('variants') !== -1 && $this.attr('href').indexOf("products/list") !== -1)) {
        ...
        if (current === "" || current === "admin") {
          ...
          //for other url
          if ($this.attr('href').indexOf(current) !== -1 || (current.indexOf('subCategories') !== -1 && $this.attr('href').indexOf("categories/list") !== -1)) {
            $(this).addClass('active');
            $(this).parents('.collapse').prev().addClass('active');
            if ($(this).parents('.collapse').length) {
              $(this).closest('.collapse').addClass('show');
